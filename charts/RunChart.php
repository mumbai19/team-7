      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Single Students Monthly Attendence Bar Chart</h3>
        ...
        <div class="col-md-6">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Single Students Yearly Attendance Line Chart</h3>
...
for (var i=0;i<labels.length;i++)
{
  ...
  console.log(labels,labelArray);
     ...
     $("#selChart").change(function(){
                ...
                if(selected=="line")
                    {  console.log("oi");
                        RunChartLine(selected,data,labelArray,'StudentA');}
